                        ...
                        <div class="card direct-chat direct-chat-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <img class="direct-chat-img" src="{{ URL::asset('AdminLTE/dist/img/user1-128x128.jpg') }}" alt="message user image">
                                        <!-- /.direct-chat-img -->
                                    ...
                                    <div class="direct-chat-msg right">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <img class="direct-chat-img" src="{{ URL::asset('AdminLTE/dist/img/user3-128x128.jpg') }}" alt="message user image">
                                        <!-- /.direct-chat-img -->
                                        <div class="direct-chat-text">
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ URL::asset('AdminLTE/dist/img/user1-128x128.jpg') }}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/28/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ URL::asset('AdminLTE/dist/img/user7-128x128.jpg') }}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/23/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ URL::asset('AdminLTE/dist/img/user3-128x128.jpg') }}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/20/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ URL::asset('AdminLTE/dist/img/user5-128x128.jpg') }}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/10/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ URL::asset('AdminLTE/dist/img/user6-128x128.jpg') }}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">1/27/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ URL::asset('AdminLTE/dist/img/user8-128x128.jpg') }}">
