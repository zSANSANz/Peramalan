...
<head>
    ...
    <link rel="stylesheet"
          href="{{ URL::asset('AdminLTE/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
...
<div class="wrapper">
    ...
    <aside class="sidebar sidebar-dark-primary elevation-4" style="width: 220px; float: left;">
        ...
        <a href="index3.html" class="brand-link">
            <img src="{{ URL::asset('AdminLTE/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
...
<script
    src="{{ URL::asset('AdminLTE/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
<!-- Summernote -->
